    ...
    function appendMessage(message) {
        ...
        const textMessage = message.message ? `
            <div class="message-content fancy-msg-box mt-2" style="min-width: 200px;">
                    ...
                    <div class="chat-action-btns ms-2">
                        <div class="chat-action-col">
                            ...
                            <div class="dropdown-menu chat-drop-menu dropdown-menu-end">
                                <a href="#" class="dropdown-item reply-button"><span><i class="bx bx-share"></i></span><span>Reply</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ${hasImages}
                ${hasFiles}
                ${message.is_sender ? `<i class="bx ${message.is_read ? 'bx-check-double' : 'bx-check'} me-1 inactive-check" style="display: block; text-align: right;"></i>` : ''}
            </div>` : '';
